...
message("Running Ileum CD samples")
...
message("Formula:~Inflammation_revised + Age+ Gender + Treatment  + Disease_duration + cngeneson + (1|Patient/sample_id)")

zlmCond <- zlm(~Inflammation_revised + Age+ Gender + Treatment  + Disease_duration + cngeneson + (1|Patient/sample_id), sca, method = 'glmer', ebayes = FALSE, fitArgsD = list(nAGQ = 0))
