...
echo "********************************************************"
CMD1="Rscript /well/cartography/projects/analysis/302_external_oxford_datasets/TAURUS/revisions/src/001_TAURUS_DEG_MASTscript_baseline_CD_Remission_final_analysis.R \
--filename ${INPUT_FILE} \
--celltype ${CELLTYPE} \
--out_dir ${OUTPUT_PTH}"
