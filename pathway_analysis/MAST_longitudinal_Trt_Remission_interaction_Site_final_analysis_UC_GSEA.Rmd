...
```
# MAST longitudinal Remisison/Treatmnet itneraction DEG in UC (With Site) for final_analysis level annotations

```{r}
lf <- list.files(path= "../Treatment_Remission_Site/UC/final_analysis/results/", pattern="MAST_fcHurdle_summary", full.names = T)
```
...
```{r}
qsave(go_bp_msigdb_UC, file = "../Treatment_Remission_Site/UC/final_analysis/Treatment_remission_interaction_with_site_final_analysis_UC_Cluster_Profiler_Msigdb_GOBP_FGSEA_obj.qs")
```
...
```{r}
write.xlsx(go_bp_UC_df, '../Treatment_Remission_Site/UC/final_analysis/Treatment_remission_interaction_with_site_UC_final_analysis_Msig_DB_Go_BP_GSEA_results.xlsx')
```
...
```{r}
qsave(reactome_msigdb_UC, file = "../Treatment_Remission_Site/UC/final_analysis/Treatment_remission_interaction_with_site_final_analysis_UC_Cluster_Profiler_Msigdb_Reactome_FGSEA_obj.qs")
```
...
```{r}
write.xlsx(reactome_UC_df, '../Treatment_Remission_Site/UC/final_analysis/Treatment_remission_interaction_with_site_UC_final_analysis_Msig_DB_Reactome_GSEA_results.xlsx')
```
...
```{r}
qsave(hallmarks_msigdb_UC, file = "../Treatment_Remission_Site/UC/final_analysis/Treatment_remission_interaction_with_site_final_analysis_UC_Cluster_Profiler_Msigdb_hallmarks_FGSEA_obj.qs")
```
...
```{r}
write.xlsx(hallmarks_UC_df, '../Treatment_Remission_Site/UC/final_analysis/Treatment_remission_interaction_with_site_UC_final_analysis_Msig_DB_hallmarks_GSEA_results.xlsx')
```
